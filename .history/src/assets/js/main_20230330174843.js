...
mm.add("(min-width: 800px)", (context) => {
  ...
  myButton.addEventListener("mouseenter", context.onClick);
  myButton.addEventListener("mouseleave", context.onClick);
  myButton.addEventListener("mousemove", context.onClick);
