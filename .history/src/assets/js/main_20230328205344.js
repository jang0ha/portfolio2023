...
document.addEventListener("DOMContentLoaded", function () {
  ...
  mm.add({
    ...
    let headerCenter = (headerBlock.clientHeight - mainLogoEl.clientHeight) / 2;
    ...
    visualLogo
      ...
      .to(mainLogoEl, {
        ...
        transformOrigin: "0 0",
        height: `${headerBlock.clientHeight`,
        duration: 1,
        onStart: () => {
          // window.addEventListener("resize", function () {
          //   headerCenter = (headerBlock.clientHeight - subLogoEl.clientHeight) / 2;
          // })
        },
        onComplete: () => {
          console.log("finish");
