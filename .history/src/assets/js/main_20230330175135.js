...
mm.add("(min-width: 800px)", (context) => {
  ...
  myButton.addEventListener("mouseenter", context.mouseEnter);
  myButton.addEventListener("mouseleave", context.mouseLeave);
  myButton.addEventListener("mousemove", context.mouseMove);
