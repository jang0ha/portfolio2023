...
ScrollTrigger.saveStyles(".mobile, .desktop, .laptop, .tablet"); //페이지가 로드되고 해당 요소의 css를 저장하는 기능 (인라인으로 들어가는  gsap 스타일을 버려버림)
...
var Init = {
  ...
  resize: function () {
    ...
    }else  if (window.matchMedia('screen and (min-width: 1024px)')) {
        html.classList.remove("mobile");
        html.classList.remove("tablet");
