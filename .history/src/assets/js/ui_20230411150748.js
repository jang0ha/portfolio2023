...
let projectWrapperEl = document.querySelector(".project-swiper");

projectWrapperEl.forEach(list => {
  const projectListEl = document.createElement("ul").classList.add(".project-list");

  let descLists = '';
  // 설명
  list.descs.forEach(desc => 
    descLists += /*html */`
     <li>${description.desc1}</li>
      <li>${description.desc2}</li>
    `
  )
  ...
  projectListEl.items.forEach(item =>



  //   projectItem += /*html */ `
  //     <li class="swiper-slide project-item">
  //       <a href="" title="${itme.title} 프로젝트 이동" class="project-link">
  //         <h3 class="title">${itme.title}</h3>
  //         <div class="description-wrapper">
  //           <div class="left-side">
  //             <p>기업 통합 검진 대행 플랫폼 사이트 </p>
  //             <p>임직원 사이트(FRONT), 통합 관리자 사이트(ADMIN)</p>
  //           </div>
  //           <div class="right-side">
  //             <ul class="disc-style">
  //               <li>PC / MOBILE 반응형</li>
  //               <li>7 MONTH / 3 / 80% (Total) </li>
  //             </ul>
  //           </div>
  //           <div class="date-side">
  //             22.07-23.01
