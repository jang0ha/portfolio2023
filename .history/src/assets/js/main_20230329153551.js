...
mm.add({
  ...
  window.addEventListener("resize", context.visalLogoEvent);

  return () => {
    window.removeEventListener("resize", context.visalLogoEvent);
  }
})


// 헤더 로고 애니메이션
function visualLogoFix() {
